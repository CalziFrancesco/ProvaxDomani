<script>
  ...
  // Funzione per generare stelle rating
  ...
  // Funzione per ottenere le classi CSS del bottone in base alla pagina
  ...
  // Funzione per ottenere il testo del bottone in base alla pagina
  ...
  async function aggiungiAlCarrello() {
    try {
      const res = await fetch(`http://localhost:3080/carrello/utente/aggiungi`, {
        method: 'PUT',
        headers: {
